            ...
            <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
              <div class="lg:max-w-md">
                ...
                <p class="px-4 mb-10 text-base leading-7 text-gray-500 ">
                  We are your trusted destination for cutting-edge technology
                  and electronics. With a passion for innovation and exceptional
                  customer service, we offer a curated selection of the latest
                  gadgets, from smartphones to smart home devices. Explore our
                  store to stay connected and elevate your digital lifestyle.
                </p>
                <div class="flex flex-wrap items-center">
                  <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                    <div class="p-6 bg-white ">
                      ...
                      <h2 class="text-sm text-gray-700 ">Total Sell</h2>
                    </div>
                  </div>
                  <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                    <div class="p-6 bg-white ">
                      ...
                      <h2 class="text-sm text-gray-700 ">Customers</h2>
                    </div>
                  </div>
                  <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                    <div class="p-6 bg-white ">
                  ...
                  <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                    <div class="p-6 bg-white ">
                      ...
                      <h2 class="text-sm text-gray-700 ">Support</h2>
                    </div>
                  </div>
                </div>
              </div>
