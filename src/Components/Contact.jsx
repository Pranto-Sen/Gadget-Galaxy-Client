...
const Contact = () => {
  return (
    <div>
      <div class="flex items-center bg-zinc-100 font-poppins dark:bg-gray-800 ">
        <div class="max-w-6xl px-4 py-4 mx-auto lg:py-11 md:px-6">
          ...
          <div class="flex flex-wrap mb-6">
            <div class="w-full px-4 mb-20 lg:w-1/3 lg:mb-0">
              <div class="relative h-full px-6 pt-20 pb-12 text-center shadow bg-gray-50 dark:bg-gray-900">
                <div class="absolute top-0 inline-flex items-center justify-center w-20 h-20 text-blue-600 transform -translate-x-1/2 -translate-y-1/2 bg-blue-100 border border-blue-600 rounded-full dark:text-gray-400 dark:border-gray-700 dark:bg-gray-700 left-1/2 ">
                  <svg
                ...
                <h2 class="mb-6 text-3xl font-bold md:text-4xl dark:text-gray-300">
                  Email
                </h2>
                {/* <h3 class="mb-6 text-lg font-medium dark:text-gray-500">
                  Lorem ipsum dor amet set ispicus dor san amet
                </h3> */}
                <p class="text-xl text-gray-500 sm:text-2xl dark:text-gray-400">
                  abc@gmail.com
                </p>
              </div>
            </div>
          ...
          <div class="px-3 py-6 ">
            <form
              action=""
              class="py-6 rounded shadow dark:bg-gray-900 bg-gray-50"
            >
              ...
              <div class="px-3 mb-6">
                ...
                <textarea
                  ...
                  required
                  class="block w-full px-4 py-10 leading-tight text-gray-700 bg-gray-100 rounded dark:placeholder-gray-500 dark:text-gray-400 dark:border-gray-800 dark:bg-gray-800 "
                ></textarea>
              </div>
              <div class="px-6">
